      ...
      '@graph': [
        ...
        // ── Person (canonical, language-neutral @id AND name) ──
        {
          ...
          subjectOf: [
            ...
            {
              '@type': 'NewsArticle',
              name: "Безкоштовна бібліотека з трейдингу: інтерв'ю з автором курсу на 50+ статей",
              headline:
                "Безкоштовна бібліотека з трейдингу: інтерв'ю з автором курсу на 50+ статей",
              author: { '@type': 'Person', name: 'Денис Мацеєвський' },
              url: 'https://ua.news/ua/money/bezkoshtovna-biblioteka-z-treidingu-interviu-z-avtorom-kursu-na-50-statei',
