...
@Component({
  selector: 'app-home-ru-blog-onehundred-seventeen',
  templateUrl: './home-ru-blog-onehundred-seventeen.component.html',
  styleUrl: './home-ru-blog-onehundred-seventeen.component.scss',
})
export class HomeRuBlogOnehundredSeventeenComponent {
  constructor(
    private meta: Meta,
      ...
      '@graph': [
        {
          ...
          mainEntityOfPage: {
            '@type': 'WebPage',
            '@id': 'https://arapov.trade/ru/freestudying/bonds-coupon-yield',
          },
          image: {
            '@type': 'ImageObject',
  ...
  private setFaqSchema(): void {
    const data = {
      ...
      mainEntity: [
        ...
        {
          '@type': 'Question',
          name: 'Что такое купон и номинал?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Номинал это сумма, которую эмитент вернёт в дату погашения. Купон это процент, который он платит за пользование вашими деньгами, обычно раз в полгода или год.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Государственные облигации считаются одними из самых надёжных, корпоративные рискованнее. Но надёжный не значит безрисковый: остаются риск дефолта эмитента и риск падения цены при росте ставок.',
          },
        },
      ],
    };
  ...
  private setHowToSchema(): void {
    const data = {
      '@context': 'https://schema.org',
      '@type': 'HowTo',
      '@id': 'https://arapov.trade/ru/freestudying/bonds-coupon-yield#howto',
      ...
      step: [
        ...
        },
        {
          '@type': 'HowToStep',
          position: 2,
          name: 'Поймите ключевые параметры',
          text: 'У облигации есть номинал, купон, дата погашения и доходность, а её цена на рынке обратно связана со ставкой центробанка.',
        },
        {
          '@type': 'HowToStep',
          position: 3,
          name: 'Различайте виды и риски',
          text: 'Государственные облигации надёжнее, но доходнее корпоративные; главные риски это дефолт эмитента и изменение ставки.',
        },
        {
          '@type': 'HowToStep',
          position: 4,
          name: 'Не путайте надёжный с безрисковым',
          text: 'Облигация это инструмент предсказуемого дохода, а не поле для трейдера; надёжная не значит безрисковая, остаются дефолт и риск ставки.',
        },
      ],
    };
